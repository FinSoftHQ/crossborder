                                    ...
                                    <tr v-for="item in orderItems"
                                        ...
                                        <td class="whitespace-nowrap py-4 md:w-[384px]">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <a href="#"
                                                   class="hover:underline">{{ item.type }}</a>
                                            </div>
                                        </td>
                                        <td class="p-4 text-base font-normal text-gray-900 dark:text-white">
                                            {{ `₿ ${item.pricePerNight.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g,
                                                ',')}` }}
                                        </td>
                                        <td class="p-4 text-base font-normal text-gray-900 dark:text-white">
                                            {{ item.nights }} คืน
                                        ...
                                        <td class="p-4 text-right text-base font-bold text-gray-900 dark:text-white">
                                            {{ `₿ ${(item.pricePerNight *
                                                item.nights).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}` }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
const orderItems = ref([
    {
        ...
        type: 'Double Bed',
        capacity: '2 Adults',
        image: 'https://hotelsup.co/wp-content/uploads/2022/05/Double.png',
        available: true,
        hotelName: 'Hilton',
        nights: 2, // Add nights property
    },
    {
        id: 2,
        name: '102',
