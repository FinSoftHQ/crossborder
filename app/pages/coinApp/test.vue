<template>
    <UContainer>
        <section class="bg-white py-4 antialiased dark:bg-gray-900 md:py-16">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Wallet</h3>

        <UCard class="mb-8">
        <div class="flex flex-col gap-4">
            <UIcon name="i-ion-wallet"
                   class="h-10 w-10 text-sky-500 dark:text-blue-400" />
    ...
    <UCard @submit.prevent="onSubmitPassword">
        ...
        <div class="grid grid-cols-1 gap-4 mt-4 mb-4">
            <UButton to="/coinApp/qrCode"
                     class="flex justify-center">สร้าง QR Code</UButton>
        </div>
