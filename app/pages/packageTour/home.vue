  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="mb-2 flex items-center justify-center  rounded-lg">
            <div class="flex items-center justify-center">
              <p class="text-sm font-bold text-gray-700 dark:text-white">พ.ค. 68 - มิ.ย. 68</p>
            </div>
            </div>
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="https://www.planetholidaystravel.com/wp-content/uploads/2025/04/banner-JSL221_310325-110800-1.jpg" alt="" />
            <img class="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
          </a>
        </div>
        <div class="pt-6">
          <a href="#" class="text-md font-semibold leading-tight text-gray-900 hover:underline dark:text-white">ทัวร์ญี่ปุ่น ช้อปปิ้ง ชิลล์ โตเกียว ชินจูกุ อาซากุสะ นาริตะ โอไดบะ (SL)</a>
          ...
          <div class="mt-8 flex items-center gap-2">
            <div class="flex items-center">
              ...
              <p class="text-sm font-bold text-gray-500 dark:text-white">4 วัน 3 คืน</p>
            </div>
          </div>

          <div class="mt-2 flex items-center gap-2">
            <div class="flex items-center">
              <UIcon name="i-ion:bed-outline" class="mr-2" />
          ...
          <div class="mt-2 flex items-center gap-2">
            <div class="flex items-center">
              <UIcon name="i-clarity:plane-line" class="mr-2" />
                <img src="https://logos-download.com/wp-content/uploads/2016/05/Lion_Air_logo_logotype.png" alt="Lion Air Logo" class="h-5 " />
            </div>
          </div>

          <p class="text-xs font-extrabold leading-tight text-gray-500 dark:text-white mt-3">ราคาเริ่มต้น บาท/ท่าน</p>
          <div class="flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-red-700 dark:text-white">19,888</p>

            <NuxtLink to="/packageTour/detail" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
              ดูรายละเอียด
            </NuxtLink>
          </div>
        </div>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="mb-2 flex items-center justify-center  rounded-lg">
            <div class="flex items-center justify-center">
              <p class="text-sm font-bold text-gray-900 dark:text-white">22 - 26 ม.ค. 68</p>
            </div>
            </div>
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="https://www.planetholidaystravel.com/wp-content/uploads/2025/01/Banner-12.png" alt="" />
            <img class="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
          </a>
        </div>
        <div class="pt-6">
          <a href="#" class="text-md font-semibold leading-tight text-gray-900 hover:underline dark:text-white">JAPAN ALPS SNOWWALL TOKYO OSAKA 6D 4N โดยสายการบินไทยแอร์เอเชีย เอ็กซ์ [XJ]</a>
          ...
          <div class="mt-2 flex items-center gap-2">
            <div class="flex items-center">
              <UIcon name="i-heroicons-calendar-days" class="mr-2" />
              <p class="text-sm font-bold text-gray-500 dark:text-white">5 วัน 3 คืน</p>
            </div>
          </div>
          ...
          <p class="text-xs font-extrabold leading-tight text-gray-500 dark:text-white mt-3">ราคาเริ่มต้น บาท/ท่าน</p>
          <div class="flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-red-700 dark:text-white">19,999</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="mb-2 flex items-center justify-center  rounded-lg">
            <div class="flex items-center justify-center">
              <p class="text-sm font-bold text-gray-900 dark:text-white">พ.ค. 68 - ก.ย. 68</p>
            </div>
            </div>
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="https://www.planetholidaystravel.com/wp-content/uploads/2025/03/BT-FUK04_VZ-1.jpg" alt="" />
            <img class="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
          </a>
        </div>
        <div class="pt-6">
          ...
          <p class="text-xs font-extrabold leading-tight text-gray-500 dark:text-white mt-3">ราคาเริ่มต้น บาท/ท่าน</p>
          <div class="flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-red-700 dark:text-white">22,999</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="https://www.planetholidaystravel.com/wp-content/uploads/2025/03/BT-FUK03_VZ-1.jpg" alt="" />
            <img class="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
          </a>
        </div>
        <div class="pt-6">
          ...
          <p class="text-xs font-extrabold leading-tight text-gray-500 dark:text-white mt-3">ราคาเริ่มต้น บาท/ท่าน</p>
          <div class="flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-red-700 dark:text-white">24,996</p>
