    ...
    <section class="py-8 antialiased dark:bg-gray-900 md:py-12">
      <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div>
            <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">โปรแกรมทัวร์</h2>
          </div>
        ...
        <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
          <div v-for="tour in tours"
            ...
            <div class="pt-6">
              <a href="#"
                 class="text-md font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ tour.title
                }}</a>
              ...
              <p class="text-xs font-extrabold leading-tight text-gray-500 dark:text-white mt-3">ราคาเริ่มต้น บาท/ท่าน
              </p>
              <div class="flex items-center justify-between gap-4">
                <p class="text-2xl font-extrabold leading-tight text-red-700 dark:text-white">{{ tour.price }}</p>
            ...
            <div class="px-4 md:px-5">
              <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="-mb-px flex flex-wrap text-center text-sm font-medium"
                  ...
                  <li class="mr-1"
                      role="presentation">
                    <button class="inline-block pb-2 pr-1"
                            id="brand-tab"
                ...
                <div class="grid grid-cols-2 gap-4 md:grid-cols-3"
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="apple"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Apple (56) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="asus"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Asus (97) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="acer"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Acer (234) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="allview"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Allview (45) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="asus"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Atari (176) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="amd"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> AMD (49) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="aruba"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Aruba (16) </label>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="beats"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Beats (56) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="bose"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Bose (97) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="benq"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> BenQ (45) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="bosch"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Bosch (176) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="brother"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Brother (176) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="biostar"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Biostar (49) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="braun"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Braun (16) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="blaupunkt"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Blaupunkt (45) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="benq2"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> BenQ (23) </label>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="canon"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Canon (49) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="cisco"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Cisco (97) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="cowon"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Cowon (234) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="clevo"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Clevo (45) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="corsair"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Corsair (15) </label>
                    </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="dell"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Dell (56) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="dogfish"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Dogfish (24) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="dyson"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Dyson (234) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="dobe"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Dobe (5) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="digitus"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Digitus (1) </label>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="emetec"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Emetec (56) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="extreme"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Extreme (10) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="elgato"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Elgato (234) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="emerson"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Emerson (45) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="emi"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> EMI (176) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="fugoo"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Fugoo (49) </label>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="fujitsu"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Fujitsu (97) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="fitbit"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Fitbit (56) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="foxconn"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Foxconn (234) </label>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <label for="floston"
                             class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Floston (45) </label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-4"
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                  <div class="grid grid-cols-2 gap-3">
                    <div>
                      <label for="min-price"
                             class="block text-sm font-medium text-gray-900 dark:text-white"> Min Price </label>
                      <input id="min-price"
                             type="range"
                             min="0"
                             max="7000"
                    ...
                    <div>
                      <label for="max-price"
                             class="block text-sm font-medium text-gray-900 dark:text-white"> Max Price </label>
                      <input id="max-price"
                             type="range"
                             min="0"
                             max="7000"
                  ...
                  <div class="space-y-3">
                    <div>
                      <label for="min-delivery-time"
                             class="block text-sm font-medium text-gray-900 dark:text-white"> Min Delivery Time (Days)
                      </label>
                    ...
                    <li class="w-full border-r border-gray-200 dark:border-gray-600">
                      <div class="flex items-center pl-3">
                        ...
                        <label for="condition-all"
                               class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-300"> All
                        </label>
                      </div>
                    </li>
                    <li class="w-full border-r border-gray-200 dark:border-gray-600">
                      <div class="flex items-center pl-3">
                        ...
                        <label for="condition-new"
                               class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-300"> New
                        </label>
                      </div>
                    </li>
                    <li class="w-full">
                      <div class="flex items-center pl-3">
                        ...
                        <label for="condition-used"
                               class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-300"> Used
                        </label>
                      </div>
                    </li>
                  </ul>
                    ...
                    <div class="space-y-2">
                      <div class="flex items-center">
                        ...
                        <label for="under-1-kg"
                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Under 1 kg </label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="1-1-5-kg"
                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1-1,5 kg </label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="1-5-2-kg"
                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1,5-2 kg </label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="2-5-3-kg"
                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 2,5-3 kg </label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="over-3-kg"
                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Over 3 kg </label>
                      </div>
                    </div>
                  </div>
                </div>
