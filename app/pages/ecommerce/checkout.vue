                ...
                <ol
                    ...
                    <li
                        ...
                        <span
                            ...
                            <svg class="me-2 h-4 w-4 sm:h-5 sm:w-5"
                                 aria-hidden="true"
                ...
                <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                    <div class="min-w-0 flex-1 space-y-8">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ms-4 text-sm">
                                            ...
                                            <p id="credit-card-text"
                                               class="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">Pay
                                                with
                                                your credit card</p>
                                        </div>
                                    </div>
                        ...
                        <!-- <div>
                            <label for="voucher"
                                ...
                                card,
                                voucher or promotional code </label>
                    ...
                    <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                        ...
                        <div class="space-y-3">
                            ...
                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400">One or more items in your
                                cart
                                require an account. <a href="#"
                                   title=""
