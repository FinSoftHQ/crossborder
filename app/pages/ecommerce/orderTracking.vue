        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:gap-8">
                <div
                    ...
                    <div class="space-y-4 p-6" v-for="product in products" :key="product.id">
                        <div class="flex items-center gap-6">
                            <a href="#" class="h-14 w-14 shrink-0">
                                <img class="h-full w-full dark:hidden" :src="product.image.light" :alt="product.name" />
                                <img class="hidden h-full w-full dark:block" :src="product.image.dark" :alt="product.name" />
                            </a>
