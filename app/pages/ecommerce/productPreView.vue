            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <div class="flex justify-end">
                  <p v-if="product.weight" class="text-sm font-medium text-gray-500 dark:text-gray-400">({{ product.weight }})</p>
                  <p v-else class="text-sm font-medium text-gray-500 dark:text-gray-400">No weight specified</p>
                </div>
              </div>
            </div>
          </div>
...
const products = ref([
  ...
  },
  {
    ...
    reviews: 98,
    weight: '100 kg',
    imageUrl: 'https://www.healthxchange.sg/sites/hexassets/Assets/food-nutrition/good-reasons-to-eat-a-banana-today.jpg',
